...
RUN yum install -y -q git wget jq unzip && wget 'https://github.com/mikefarah/yq/releases/download/v4.9.8/yq_linux_amd64' -O /usr/local/bin/yq && chmod +x /usr/local/bin/yq
